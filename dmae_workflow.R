...
dm <- read_sas("~/PharmaSUG-2019-Creating-Sharing-Shiny-Apps-Gadgets/data/dm.sas7bdat")

ae <- read_sas("~/PharmaSUG-2019-Creating-Sharing-Shiny-Apps-Gadgets/data/ae.sas7bdat")
